...
contract StakeContract {
    ...
    IERC20Metadata public _BoredApeToken;
  struct  stakers {
        uint amount;
        uint timeStaked;
        uint amountDue;
    ...
    function Stake (uint _amount, uint _timeStaked, IERC20Metadata token  ) public returns (bool) {
      ...
      function WithDrawStake ( uint _presentTime, IERC20Metadata token ) public returns (bool) {
